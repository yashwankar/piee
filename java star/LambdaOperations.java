...
/* 
Learnings:
Lambda expressions does not have separate body.
using "->" operator it starts its working
here, return(n) where n can be object which will return boolean
on evaluation to the calling funtion.
